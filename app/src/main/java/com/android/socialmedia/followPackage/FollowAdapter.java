package com.android.socialmedia.followPackage;
...
public class FollowAdapter extends RecyclerView.Adapter<FollowAdapter.ViewHolder> {
    ...
    public FollowAdapter(Context context, List<followList> userList) {
    ...
    public void onBindViewHolder(@NonNull FollowAdapter.ViewHolder holder, int position) {
        ...
        holder.textView.setText(followList.getFollowingUsername());

        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Users");
        Query query = databaseReference.orderByChild("Username").equalTo(followList.getFollowingUsername());
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("username", followList.getFollowingUsername());
